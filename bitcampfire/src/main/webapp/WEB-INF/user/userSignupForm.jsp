		 ...
		 <div class="input-form-backgroud row">
      		<div class="input-form col-md-10 mx-auto">
				...
				<div class="col-md-6 mb-3">
				  ...
				  <input type="text" class="form-control" name ="user_id" id="user_id" placeholder="아이디" maxlength="20" minlength="6">
				  <input type="text" id="countId" style="border: none;">
				  <input type="hidden" name="user_id_check" value="">
				  <div id="user_idDiv"></div>
				</div>
	          	...
	          	<div class="row">
	            	<div class="col-md-6 mb-3">
	           		 ...
	           		 <div class="col-md-6 mb-3">
	             		 <label for="user_repwd" class="form-label">비밀번호 확인</label>
				...
				<div class="mb-3">
				 	<label for="class_academy" class="form-label">학원등록</label>
				 		<div class="row">
	            			<div class="col-md-8 mb-3">
	              				<input type="text" class="form-control" name="class_academy" id="class_academy" readonly>
	            			</div>
		           		 	<div class="col-md-4 mb-3">
		             			<input type="button" class="form-control" value="우편번호검색" onclick = "checkPost()"><br>
		            		</div>
	        			</div>
					<input type="text" class="form-control" name="addr1" id="addr1" placeholder="주소" size="50" readonly><br>
					<input type="text" class="form-control" name="addr2" id="addr2" placeholder="상세주소" size="50">
				</div>
				...
				<div class="col-md-6 mb-3">
					...
					<div class="user_profile">
						<div class='avatar-photo' id="avatar-photo"><img id="basic_profile_img" class="basic_profile_img" alt="basic_profile.jpg" src="../image/basic_profile.jpg"></div>
				  		<div class="camera_icon_div" id="camera_icon_div">
					  		<img src="../image/camera-fill.svg" id="camera_icon">
				  		</div>
				  		<input type="file" name ="user_img" id="user_img" hidden>
					</div>
				</div>
